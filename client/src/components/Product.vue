  ...
  <script>
    ...
    $(function() {
          ...
          if (!json.data) {
            ...
            for (let i = 0; i < json.data.length; i++) {
              ...
              if (!datalists.saveFile) {
                ...
                // innerHtml += " <td><button id=\"fileDownload\" class=\"btn btn-block btn-info\" onclick=\"fileDown("+ datalists.id +")\">download</button></td>";
                innerHtml +=
      ...
      $('form').submit(function(event) {
        ...
        // let price = $('#price').val();
        // let title = $('#title').val();
        // let field01 = $('#field01').val();
        // let field02 = $('#field02').val();
        // let field03 = $('#field03').val();
        // let field04 = $('#field04').val();
        // let field05 = $('#field05').val();
        // let file = $("input[name=file_upload]")[0].files[0];
